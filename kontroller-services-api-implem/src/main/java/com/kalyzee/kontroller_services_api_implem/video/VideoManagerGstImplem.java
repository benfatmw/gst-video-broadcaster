...
public class VideoManagerGstImplem implements VideoManager {
    ...
    public void createWebrtcFeedbackConnection(String uri) throws CreateWebrtcFeedbackConnectionException {
        ...
        try {
            ...
            webrtcSignallingClientsMap.put(signallingSocket, new KontrollerWebrtcSignallingGstClient(signallingSocket, cameraStreamPipeline));
        } catch (Exception e) {
